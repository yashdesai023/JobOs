            ...
            <AnimatePresence>
                {isAuthenticated && (
                    <motion.button
                        ...
                        className="fixed top-6 right-6 z-50 p-3 bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 rounded-xl backdrop-blur-md transition-all shadow-lg group flex items-center gap-2"
                        title="Logout"
                    >
